...
public class Games extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon-contactar.png"))); // NOI18N
    ...
    private void jmlSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmlSaveActionPerformed
        ...
        if (interfaz.verificador(codigo) == 1) {
            int resp = JOptionPane.showConfirmDialog(null, "El codigo introducido ya esta usado,acepta si quieres seguir", "Precaucion", JOptionPane.WARNING_MESSAGE, JOptionPane.YES_OPTION);
